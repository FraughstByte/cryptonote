...
const uint64_t MONEY_SUPPLY                                  = 20000000000; //20 Trillion
...
const uint64_t DIFFICULTY_TARGET                             = 30; //calculated in seconds(30)
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 24 * 60 * 60 / DIFFICULTY_TARGET; // ~2880 blocks a day 
...
const char     CRYPTONOTE_NAME[]                             = "FraughstCoin";
